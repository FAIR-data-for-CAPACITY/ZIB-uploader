...
#. use the search functionality `here <https://github.com/ FAIR-data-for-CAPACITY /zib_uploader/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the ZIB uploader repository on GitHub;
